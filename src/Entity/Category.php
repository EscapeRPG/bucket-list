...
class Category
{
    ...
    #[Assert\Unique()]
    #[Assert\NotBlank()]
    #[Assert\Length(min: 5, max: 50, minMessage: 'The category name must be at least {{ limit }} characters long.', maxMessage: 'The category name cannot be longer than {{ limit }} characters.')]
